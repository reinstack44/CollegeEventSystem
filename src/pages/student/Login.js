...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    // Domain Lockdown: Prevents unauthorized logins at the gate
    ...
    try {
      // FIX: Removed unused 'data' variable to resolve ESLint warning
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex justify-center items-start pt-16 md:pt-24 px-4 bg-[#0a0f1d]">
      <div className="bg-[#111827] p-8 md:p-10 rounded-[2.5rem] shadow-2xl border border-slate-800 w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="pt-6 text-center border-t border-slate-800/50">
            <p className="text-slate-500 text-xs font-medium">
              New student?{' '}
              <Link to="/signup" className="text-blue-500 font-black uppercase tracking-widest hover:underline">
                Register Here
              </Link>
            </p>
          </div>
